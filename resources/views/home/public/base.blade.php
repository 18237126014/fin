...
<!-- 导航栏 -->
        <div class="nav">
                            ...
                            @if(!empty($menu['list']))
                             <div class="submenu_cnt">
                                <ul class="two">
                                    ...
                                    <li>
                                        <a href="{{$list['column_chaining']}}" target="_self">
                                            <div class="menu_icon">
                                                <img src="{{$list['icon_name']}}" alt="" class="name">
                                                <img src="{{$list['icon_five']}}" alt="" class="five">
                                            </div>
                                        <p class="menu_label">{{$list['column_name']}}</p>
                                        </a>
                                    </li>
                                    @endforeach
                                </ul>
            ...
            <!-- <ul>
                ...
                <li class="pmenu">
                    <a class="gv" href="{{url('related')}}">关于我们</a>
                    <div class="submenu_cnt">
                        <ul class="one">
                            <li>
