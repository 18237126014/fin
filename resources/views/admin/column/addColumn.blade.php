                    ...
                    <div class="widget-content nopadding">
                        <form action="{{url('/admin/column/doAdd')}}" method="post" class="form-horizontal" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="column_filename" placeholder="请输入文件名" value="{{old('column_filename')}}"/>
                                    @if(count($errors)>0)
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <label><input type="radio" name="display" value="2" style="margin-right: 10px;" checked>隐藏</label>
                                </div>
                            </div>
